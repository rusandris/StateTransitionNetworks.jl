...
annotate!(pl_crit_Kq, (0.02,  1), text("(d)", :left, 15))
...
annotate!(pl_crit_Hq, (0.02,  1), text("(c)", :left, 15))
...
annotate!(pl_tent_Kq, (0.02,  1), text("(b)", :left, 15))
...
annotate!(pl_tent_Hq, (0.02,  1), text("(a)", :left, 15))
