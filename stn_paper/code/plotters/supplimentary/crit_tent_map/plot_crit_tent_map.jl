...
plot!(pl_crit_Kq, xlabel="", ylabel=L"\tilde{K}_q(m)", ylim=[0,1.2], xformatter=:none,guidefontsize=guidefontsize, tickfontsize=14, legendfontsize=16, dpi=300)
plot!(pl_crit_Kq, xlim=[0,2], ylim=[0.,2.], yticks=[0,0.5,1], legend=:topright, left_margin=3Plots.mm)
...
plot!(pl_crit_Hq, xlabel="", ylabel=L"H_q(m)/m", xformatter=:none, guidefontsize=guidefontsize, tickfontsize=14, legendfontsize=16, dpi=300)
plot!(pl_crit_Hq, xlim=[0,2], ylim=[0,2], legend=:topright, left_margin=3Plots.mm)
#plot!(pl, ylim=[0,2.5])
...
plot!(pl_tent_Kq, xlabel=L"q", ylabel=L"\tilde{K}_q(m), K_q", ylim=[0,1.2], xguidefontsize=22, yguidefontsize=22, tickfontsize=14, legendfontsize=16, dpi=300)
...
plot!(pl_tent_Hq, xlabel=L"q", ylabel=L"H_q(m)/m", xguidefontsize=22, yguidefontsize=22, tickfontsize=14, legendfontsize=16, dpi=300)
plot!(pl_tent_Hq, xlim=[0,2], ylim=[0,1.1], legend=:bottomleft, left_margin=3Plots.mm)
#annotate!(pl, (-0.18,  1), text("(a)", :left, 24))
...
pl = plot(pl_crit_Hq,pl_crit_Kq,pl_tent_Hq,pl_tent_Kq,layout=(2,2),size=colfig_size)
