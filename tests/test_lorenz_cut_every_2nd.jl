...
for index in eachindex(rho)
    ...
    splot = hline([entropy], linewidth = 3, linecolor=:red, label="True value")
    boxplot!( splot,
        ticks_place, S, 
        xlabel= L"\Delta T",
        ylabel = L"S_{KS}",
    ...
    lplot = hline([lyapunov], linewidth = 3, linecolor=:red, label="True value")
    boxplot!( lplot,
    ...
    boxplot!( lyap,
        ...
        fillalpha=0.75,
        fillcolor=:palegreen)
    hline!(lyap, [lyapunov], linewidth = 3, linecolor=:red, label="True value")
